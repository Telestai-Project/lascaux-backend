...
class UserBase(BaseModel):
    ...
    followers_count: int = Field(default=0, description="Number of followers the user has")
...
class UserUpdate(BaseModel):
    ...
    followers_count: Optional[int] = Field(None, description="Updated followers count")
